...
return [
    ...
    'patterns' => [
        ...
        'base' => '#^(((([0-9a-z]+?)((?:p[0-9a-z]{2,3}|p\d{4}|d[0-9a-z]{2}|d\d{4}|c[0-9a-z]{2}|c\d{4})?))((?:p[0-9a-z]{2,3}|p\d{4}|d[0-9a-z]{2}|d\d{4}|c[0-9a-z]{2}|c\d{4})?))((?:p[0-9a-z]{2,3}|p\d{4}|d[0-9a-z]{2}|d\d{4}|c[0-9a-z]{2}|c\d{4})?))(?:-f\d)?\.(?:dat|png)$#i',
    ],
];
