...
return [
    ...
    'patterns' => [
        ...
        'base' => '#^(?P<base>[0-9a-z]+?)(?P<suffix1>p[0-9abe-z][0-9a-z]|p[cd][1-9a-z]{2}|[cdk][0-9a-z]{2}|[pcd]\d{4})?(?P<suffix2>p[0-9abe-z][0-9a-z]|p[cd][1-9a-z]{2}|[cd][0-9a-z]{2}|[pcd]\d{4})?(?P<suffix3>p[0-9abe-z][0-9a-z]|p[cd][1-9a-z]{2}|[cd][0-9a-z]{2}|[pcd]\d{4})?(?:-f\d)?\.(?:dat|png)$#i',
    ],
];
