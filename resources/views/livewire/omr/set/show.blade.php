    ...
    <div class="flex flex-col space-y-2">
        ...
        <div class="grid grid-cols-12 gap-2">
            ...
            <div class="flex flex-col col-span-4 space-y-2">
                ...
                @forelse($set->models->sortBy('alt_model') as $model)
                ...
                @empty
                    <div class="rounded border border-gray-200 text-lg font-bold bg-gray-200 p-2">No Models Yet</div>
                @endforelse
            </div>
        </div>
    </div>
